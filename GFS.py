...
data_fld= "https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?dir=%2Fgfs.{0:04d}{1:02d}{2:02d}%2F{3:02d}%2Fatmos&file=gfs.t{4:02d}z.pgrb2.0p25.f{5:03d}&all_var=on&lev_2_m_above_ground=on&lev_10_m_above_ground=on \
&lev_925_mb=on&lev_850_mb=on&lev_700_mb=on&lev_500_mb=on&lev_400_mb=on&lev_300_mb=on&lev_surface=on&lev_mean_sea_level=on&subregion=&toplat=90&leftlon=60&rightlon=240&bottomlat=0"
